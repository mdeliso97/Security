...
# CBC encryption
def cbc_encrypt(file, password, filename, extension):
    BLOCK_SIZE = 32  # Bytes
    ...
    json_output = json.dumps({'iv': iv_key, 'ciphertext': ct_key, 'filename': filename, 'extension': extension})
...
def cbc_decrypt(json_file, key):
    ...
    return decrypted_file, filename, extension
